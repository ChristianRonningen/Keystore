...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Brad Parbs/Keystore'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Brad Parbs' => 'brad@bradparbs.com' }
  s.source           = { :git => 'https://github.com/Brad Parbs/Keystore.git', :tag => s.version.to_s }
